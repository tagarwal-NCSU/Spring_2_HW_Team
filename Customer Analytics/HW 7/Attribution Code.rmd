...
df <- fread("C:\\Users\\bakea091\\Documents\\Class\\DoE_2022\\travel_path\\TravelData.csv")
df <- select(df, 'UserID', 'PurchaseID', 'TIMESPSS', 'type_touch', 'purchase_any')
colnames(df) <- c('UserID', 'PathID', 'TimeStamp', 'TouchType', 'Purchase')

df_meta <- readxl::read_excel("C:\\Users\\bakea091\\Documents\\Class\\DoE_2022\\travel_path\\codebook.xlsx")
